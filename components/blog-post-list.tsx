...
const BlogPostList: NextPage<BlogPostListType> = ({ className = "" }) => {
  return (
    <div
      className={`w-[77.688rem] flex flex-row items-start justify-start gap-[1.875rem] max-w-full text-left text-[1rem] text-darkgray font-poppins mq1150:flex-wrap ${className}`}
    >
      <div className="flex-1 flex flex-col items-start justify-start pt-[1.375rem] px-[0rem] pb-[0rem] box-border max-w-full mq800:min-w-full">
        <div className="self-stretch flex flex-col items-start justify-start gap-[3.375rem] max-w-full z-[1] mq450:gap-[1.688rem]">
          <GroupComponent13
            previewImages="/rectangle-68@2x.png"
            wood="Wood"
            goingAllInWithMillennialD="Going all-in with millennial design"
          />
          <GroupComponent13
            previewImages="/rectangle-68-1@2x.png"
            wood="Handmade"
          ...
          />
          <GroupComponent13
            previewImages="/rectangle-68-2@2x.png"
            wood="Wood"
      ...
      <div className="w-[24.563rem] flex flex-col items-start justify-start gap-[2.562rem] min-w-[24.563rem] max-w-full text-[1.5rem] text-black mq450:gap-[1.25rem] mq800:min-w-full mq1150:flex-1">
        ...
        <div className="self-stretch bg-white flex flex-col items-start justify-start py-[1rem] pr-[4.062rem] pl-[4.75rem] box-border gap-[1.625rem] max-w-full z-[1] text-[0.875rem] mq450:pl-[1.25rem] mq450:pr-[1.25rem] mq450:box-border">
