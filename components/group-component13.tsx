...
const GroupComponent13: NextPage<GroupComponent13Type> = ({
  ...
  return (
    <div
      className={`self-stretch h-[49.625rem] flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[4.125rem] box-border gap-[1.062rem] max-w-full text-left text-[1rem] text-darkgray font-poppins mq450:h-auto mq450:pb-[1.75rem] mq450:box-border mq1150:pb-[2.688rem] mq1150:box-border ${className}`}
    >
